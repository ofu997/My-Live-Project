...
namespace Podcast
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/WebBlog").Include(
               // App init
            ...
            // Include all relavant javascript files here that will be true for every page
            bundles.Add(new ScriptBundle("~/bundles/jquery").Include(
                        //"~/Scripts/app/modules/calendar.js",
                        "~/Scripts/js/jquery.min.js",
                        "~/Scripts/bootstrap.min.js",
                        "~/Scripts/slider-revolution/js/jquery.themepunch.tools.min.js",
                        "~/Scripts/slider-revolution/js/jquery.themepunch.revolution.min.js",
                        "~/Scripts/slider-revolution/js/extensions/revolution.extension.parallax.min.js",
                        "~/Scripts/slider-revolution/js/extensions/revolution.extension.video.min.js",
                        "~/Scripts/slider-revolution/js/extensions/revolution.extension.slideanims.min.js",
                        "~/Scripts/slider-revolution/js/extensions/revolution.extension.navigation.min.js",
                        "~/Scripts/slider-revolution/js/extensions/revolution.extension.layeranimation.min.js",
            ...
            // Minified versions of the above.  Doesn't quite work if anyone feels like debugging
            //bundles.Add(new ScriptBundle("~/bundles/jquery").Include(
            //            "~/Scripts/js/jquery.min.js",
            //            "~/Scripts/bootstrap.min.js",
            //            "~/Scripts/slider-revolution/js/MasterThemepunchRevolution.js",
            //            "~/Scripts/slider-revolution/js/extensions/MasterRevolutionExtension.js",
            //            "~/Scripts/js/MasterTemplateScripts.js",
            //            "~/Scripts/jquery.signalR-2.2.1.min.js",
            ...
            bundles.Add(new StyleBundle("~/bundles/content").Include(
                      ...
                      "~/Scripts/slider-revolution/css/settings.css",
                      "~/Scripts/slider-revolution/css/layers.css",
                      "~/Scripts/slider-revolution/css/navigation.css",
                      "~/Content/SASS/Site.min.css"
                      //"~/Vendor/fullcalendar/dist/fullcalendar.css"

                      ));

            bundles.Add(new ScriptBundle("~/bundles/react").Include(
                "~/Scripts/React-Redux-App/bundle.js"));
            ...
            bundles.Add(new ScriptBundle("~/bundles/animo.js").Include(
            "~/Vendor/animo.js/animo.js"));
